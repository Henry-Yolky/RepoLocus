...
from devpilot.parsers.base import ParseResult, ParserRegistry, SourceParser
from devpilot.parsers.heuristic import HeuristicParser
from devpilot.parsers.python import PythonParser


def build_default_registry() -> ParserRegistry:
    """Create a registry containing DevPilot's built-in parsers."""

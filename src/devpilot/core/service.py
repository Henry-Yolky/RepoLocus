"""High-level, side-effect-bounded DevPilot workflows."""
...
from devpilot.generators import MermaidGenerator, ProjectMapGenerator
from devpilot.index import RepositoryIndex
from devpilot.models import Answer, Confidence, Evidence, IndexUpdate, ScannedFile, ScanResult
from devpilot.providers import create_provider, provider_family
...
class DevPilotService:
        ...
        if not evidence:
            answer = Answer(
                text=(
                    ...
                    "more specific question; DevPilot will not invent an answer."
                ),
                evidence=(),
    ...
    def _extractive_answer(self, question: str, evidence: list[Evidence]) -> Answer:
        ...
        lines = [
            ...
            "",
            "DevPilot found these source-backed locations. Inspect them in order; no model was "
